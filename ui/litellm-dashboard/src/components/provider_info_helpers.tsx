export enum Providers {
  A2A_Agent = "A2A Agent",
  AIML = "AI/ML API",
  Antigravity = "Antigravity (Claude & Gemini)",
...
export const providerLogoMap: Record<string, string> = {
  ...
  [Providers.Antigravity]: `${asset_logos_folder}google.svg`,
...
export const getProviderModels = (provider: Providers, modelMap: any): Array<string> => {
  ...
  if (providerKey && typeof modelMap === "object") {
    ...
    // Special case for Antigravity - return predefined models
    if (providerKey == Providers.Antigravity) {
      providerModels = [
