              ...
              <>
                ...
                >
                  {({ getFieldValue }) => {
                    ...
                    if (selectedProvider === Providers.Antigravity) {
                      return (
                        <>
                          <div className="flex items-center my-4">
                            <div className="flex-grow border-t border-gray-200"></div>
                            <span className="px-4 text-gray-500 text-sm">Antigravity Authentication</span>
                            <div className="flex-grow border-t border-gray-200"></div>
                          </div>
                          <Alert
                            message="Antigravity uses Google OAuth"
                            description={
                              <div>
                                <p>Antigravity requires Google account authentication. Manage your accounts in Settings.</p>
                                <Button type="link" href="/settings/antigravity" style={{ paddingLeft: 0 }}>
